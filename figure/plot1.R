...
epcDates <- subset(epc, epc$Date == "1/2/2007" | epc$Date == "2/2/2007")
...
png(filename = "plot1.png", width = 480, height = 480, background = "transparent")
hist(as.numeric(epcDates$Global_active_power), 
     col = "red",
